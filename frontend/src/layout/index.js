...
const useStyles = makeStyles((theme) => ({
  ...
  logoContainer: {
    ...
    background: "linear-gradient(90deg, #0000FF, #FF1493)", // Gradiente de azul para rosa pink
  },
  logo: {
    width: "100%",
    height: "100%",
    objectFit: "cover",
    borderRadius: "50%", // Garante que a imagem siga o formato redondo
  },
  appBar: {
    ...
    backgroundImage: `
      ...
      linear-gradient(90deg, #0000FF, #FF1493)
    `, // Gradiente de azul para rosa pink com uma barriga no meio
  },
  appBarShift: {
