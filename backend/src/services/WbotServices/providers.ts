                ...
                axios.request(optionsListpaymentOVERDUE as any).then(async function (response) {
                  ...
                  if (totalCount_overdue === 0) {
                    ...
                    axios.request(optionsPENDING as any).then(async function (response) {
                      ...
                      var optionsGetPIX = {
                        method: 'GET',
                        url: `https://api.asaas.com/v3/payments/${id_payment_pending}/pixQrCode`,
                        headers: {
                          'Content-Type': 'application/json',
                          access_token: asaastk
                        }
                      ...
                      axios.request(optionsGetPIX as any).then(async function (response) {
                        ...
                        if (success === true) {
                          ...
                          var optionsBoletopend = {
                            method: 'GET',
                            url: `https://api.asaas.com/v3/payments/${id_payment_pending}/identificationField`,
                            headers: {
                              'Content-Type': 'application/json',
                              access_token: asaastk
                            }
                    ...
                    var optionsGetPIX = {
                      method: 'GET',
                      url: `https://api.asaas.com/v3/payments/${id_payment_overdue}/pixQrCode`,
                      headers: {
                        'Content-Type': 'application/json',
                        access_token: asaastk
                      }
                    ...
                    axios.request(optionsGetPIX as any).then(async function (response) {
                      ...
                      if (success === true) {
                        ...
                        var optionsBoleto = {
                          method: 'GET',
                          url: `https://api.asaas.com/v3/payments/${id_payment_overdue}/identificationField`,
                          headers: {
                            'Content-Type': 'application/json',
                            access_token: asaastk
                          }
